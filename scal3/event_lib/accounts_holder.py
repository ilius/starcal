...
from .accounts import DummyAccount, accountsDir
...
class EventAccountsHolder(ObjectsHolderTextModel[AccountType]):
	...
	# FIXME: types
	def getLoadedObj(self, obj: DummyAccount) -> AccountType | None:
		ident = obj.id
	...
	def replaceDummyObj(self, obj: DummyAccount) -> AccountType:
		ident = obj.id
