...
confOptionsData: list[OptionData] = [
	...
	OptionData(
		...
		flags=CUSTOMIZE,
		type="float",
		annotated="FloatSpin(0, 1, 0.01, 3)",
		where="MainWin: Customize: Right Panel: Sizes",
	...
	OptionData(
		...
		flags=CUSTOMIZE,
		type="float",
		annotated="FloatSpin(0.01, 1, 0.1, 3)",
