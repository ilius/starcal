...
confParamsData: list[Param] = [
	...
	Param(
		name="weekcal.weekDays.font",
		v3Name="wcalFont_weekDays",
		flags=CUSTOMIZE,
	),
	Param(
		name="weekcal.pluginsText.font",
