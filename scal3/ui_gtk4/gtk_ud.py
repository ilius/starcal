...
if _screenSize is None:
	if _workAreaSize is None:
		raise OSError("neither screen size nor workspace size was detected")
	log.warning("screen size was not detected")
	_screenSize = _workAreaSize

screenW, screenH = _screenSize
if _workAreaSize is None:
	log.warning("workspace size was not detected")
