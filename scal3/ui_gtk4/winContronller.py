...
@registerSignals
class WinConButton(gtk.Image, CustomizableCalObj):
	hasOptions = False
	expand = False
	...
	def __init__(self, controller):
		...
		eventCon = gtk.EventControllerLegacy()
		self.add_controller(eventCon)
		eventCon.connect("event", self.onEvent)
	...
	def onEvent(self, *args):
		# FIXME
		print("WinConButton.onEvent", *args)
