...
class NodeType(Protocol):
	...
	@property
	def left(self) -> NodeType | None: ...

	@left.setter
	def left(self, x: NodeType | None) -> None: ...

	@property
	def right(self) -> NodeType | None: ...

	@right.setter
	def right(self, x: NodeType | None) -> None: ...
