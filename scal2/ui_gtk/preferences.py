...
class PrefDialog(gtk.Dialog):
    def __init__(self, mainWin):
        ...
        #eb = gtk.EventBox()
        vb = gtk.VBox()
        vb.pack_start(image_from_file('%s/preferences-other.png'%pixDir))
        vb.pack_start(l)
        #eb.add(vb)
        ...
        l.set_use_underline(True)
        vb = gtk.VBox()
        vb.pack_start(image_from_file('%s/preferences-desktop-theme.png'%pixDir))
        vb.pack_start(l)
        vb.show_all()
        #vb.set_events(gtk.gdk.ALL_EVENTS_MASK)
        #vb.set_extension_events(gtk.gdk.EXTENSION_EVENTS_ALL)
        ...
        l.set_use_underline(True)
        vb = gtk.VBox()
        vb.pack_start(image_from_file('%s/preferences-plugin.png'%pixDir))
        vb.pack_start(l)
        vb.show_all()
        ...
        l.set_use_underline(True)
        vb = gtk.VBox()
        vb.pack_start(image_from_file('%s/applications-system.png'%pixDir))
        vb.pack_start(l)
        vb.show_all()
